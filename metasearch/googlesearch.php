...
//		for ($i=0;$i<count($googlearray);$i++) //not required for non-agg
//		{
...
//		}
	...
	//foreach ($googlearray as $finallist) //googlearray is the merged value
 ...
 <img src="Resources/Images/background/googlesmall.jpg" width="135" height="78" />
  ...
  // {
	...
	foreach ($alternative as $test)
	{
		...
		{
		$test3 = ucwords($test2);
		printf('<a href="google_related.php?query=%1$s">%1$s</a><br/>', $test3);
...
//		}
	...
	echo "<a href=\"{$finallist['link']}\"><img src= \"{$finallist['image']['thumbnailLink']}\" height=\"175\" width =\"225\"/></a>"; 
