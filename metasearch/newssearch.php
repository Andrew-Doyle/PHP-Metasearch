...
</div> <!--end of align centre-->
</div> <!--end of pagelinks id-->
...
require("OAuth.php");
	...
	echo "<li class=\"titlelink\"> <a href=\"{$yahoo['Url']}\"><font color ='blue'>{$yahoo['Title']}</font></a></li>"."<li class = \"displaylink\">{$yahoo['Source']}, {$yahoo['Date']}</li>"."<li class =\"snippet\">{$yahoo['Description']}</li>".$newline;
		}
...
echo'<div id="column_1_of_2b">';

		
		//################################################## BING ##########################################################################################-->		
		echo '<img src="Resources/Images/background/bingnews2.png" width="300" height="125" />';
...
echo'</div>';
		// RELATED NEWS COMMENTED OUT IT IS CURRENTLY AN UNRELIABLE FEATURE ON FIRST CLICK WITH YAHOO
...
//		{
//		$test3 = ucwords($test2);
//		printf('<li class="related_search_vertical"><a href="news_related.php?query=%1$s" title="%1$s" id="costslink">%1$s</a></li>', $test3);
//		
//		}
//		
//	}
		
//	echo'</div>'; // END OF RELATED NEWS SECTION	
echo'</div>';
...
foreach ($combinedRank as $finallist)
{
   ...
   echo'<div id="related_terms_agg_or_individual">
 <img src="Resources/Images/background/bingandyahoo.gif" width="140" height="78" />
		 <p>
   Related Searches:
   </p>';
